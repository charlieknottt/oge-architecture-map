        ...
        <div className="max-h-[70vh] overflow-y-auto">
          <div className="px-6 pt-5 pb-6">
            <div className="flex items-start justify-between gap-3 mb-3">
              <div>
                <h2 className="text-xl font-bold leading-tight mb-1" style={{ color: "#0f172a" }}>{title}</h2>
                <p className="text-xs font-medium" style={{ color: "#94a3b8" }}>{subtitle}</p>
              </div>
            ...
            <p className="text-[14px] leading-[1.7]" style={{ color: "#475569" }}>{description}</p>
          </div>
        </div>
      </div>
    </div>
