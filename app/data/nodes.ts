...
export const CONNECTIONS: Connection[] = [
  ...
  { id: "c12", from: "worldstate", to: "ai_actors", label: "State context", description: "AI actors receive state to generate initial positions and inform decisions.", style: "solid", waypoints: [{ x: 920, y: 420 }] },
